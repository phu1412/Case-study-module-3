...
<body class="hold-transition login-page" background="{{ asset('dist/img/dong-ha.jpg') }}"
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <p class="login-box-msg">Login to admin website</p>
                @if (Session::has('login-fail'))
                    <div class="login-fail">
                        <p class="text-danger">{{ Session::get('login-fail') }}</p>
                    </div>
                @endif
                <form action="{{ route('loginAdmin.login') }}" method="post">
                    @csrf
